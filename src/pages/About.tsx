        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              {getTranslatedText(
                {
                  pt: "Nossos Preços e Tarifas",
                  en: "Our Prices and Rates",
                  fr: "Nos Tarifs et Prix",
                },
                currentLanguage
              )}
            </h2>
            ...
            <p className="text-lg text-green-100 max-w-3xl mx-auto">
              {getTranslatedText(
                {
                  pt: "Consulte nossa tabela de preços completa para todos os nossos serviços de entrega e logística.",
                  en: "Check out our complete price list for all our delivery and logistics services.",
                  fr: "Consultez notre liste de prix complète pour tous nos services de livraison et logistique.",
                },
                currentLanguage
              )}
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="mb-6 text-green-100">
                  {getTranslatedText(
                    {
                      pt: "Faça o download da nossa tabela de preços completa em formato PDF para visualizar todas as nossas tarifas e opções de serviço.",
                      en: "Download our complete price list in PDF format to view all our rates and service options.",
                      fr: "Téléchargez notre liste de prix complète au format PDF pour voir tous nos tarifs et options de service.",
                    },
                    currentLanguage
                  )}
                </p>
                <a
                  href="/tarifas-topronto.pdf"
                  target="_blank"
                  ...
                  {getTranslatedText(
                    {
                      ...
                      fr: "Télécharger la Liste des Prix",
                    },
                    currentLanguage
                  )}
                </a>
                <p className="mt-3 text-sm text-green-200">
                  {getTranslatedText(
                    {
                      pt: "Formato PDF - Atualizado em Agosto 2025",
                      en: "PDF Format - Updated August 2025",
                      fr: "Format PDF - Mis à jour en Août 2025",
                    },
                    currentLanguage
                  )}
                </p>
